...
public class Program {
    ...
    private static void popuniPodatke(){
        imenik.dodaj("Ena", new FiksniBroj(Grad.SARAJEVO, "111-222"));
        imenik.dodaj("Elma", new FiksniBroj(Grad.TRAVNIK, "777-888"));
        imenik.dodaj("Azra", new MobilniBroj(61, "332-822"));
        imenik.dodaj("Lejla", new MedunarodniBroj("+44", "2288811990"));
    }
}
